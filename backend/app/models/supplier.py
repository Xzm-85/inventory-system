...
class Supplier(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)  # 供应商名称，必填
    ...
    license_expiry_date: Mapped[date | None] = mapped_column(Date)  # 证照有效期（只存日期）
